...
export function WhyChooseUsSection() {
    return (
        <section className="py-12 sm:py-16 lg:py-24 bg-[#ffffff] dark:bg-[#111827]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                    {features.map((feature) => (
                        <Card
                            key={feature.title}
                            className="p-6 sm:p-8 border-[#e5e7eb] dark:border-[#334155] hover:border-[#6C2BD9] transition-all duration-300 bg-[#ffffff] dark:bg-[#1e293b]"
                        >
                            <div className="flex flex-col sm:flex-row items-start gap-4">
                                <div className="shrink-0">
                                    <div className="flex items-center justify-center w-12 h-12 bg-[#f3e8ff] dark:bg-[#6C2BD9]/20 rounded-lg">
